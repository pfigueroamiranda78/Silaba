...
protocol LikedPostInteractorOutput: BaseModuleInteractorOutput {
    ...
    func didShare(error: PostServiceError?, postId: String)
    func didUnshare(error: PostServiceError?, postId: String)
}
...
extension LikedPostInteractor: LikedPostInteractorInput {
    ...
    func sharePost(id: String) {
        ...
        service.share(id: id) { error in
            self.output?.didShare(error: error, postId: id)
        }
    }
    ...
    func unsharePost(id: String) {
        ...
        service.unshare(id: id) { error in
            self.output?.didUnshare(error: error, postId: id)
        }
    }
