...
protocol UserPostInteractorOutput: BaseModuleInteractorOutput {
    ...
    func userPostDidShare(with postId: String, and error: PostServiceError?)
    func userPostDidUnshare(with postId: String, and error: PostServiceError?)
}
...
extension UserPostInteractor: UserPostInteractorInput {
    ...
    func share(post id: String) {
        ...
        service.share(id: id) { error in
            self.output?.userPostDidShare(with: id, and: error)
        }
    }
    ...
    func unshare(post id: String) {
        ...
        service.unshare(id: id) { error in
            self.output?.userPostDidUnshare(with: id, and: error)
        }
    }
}
